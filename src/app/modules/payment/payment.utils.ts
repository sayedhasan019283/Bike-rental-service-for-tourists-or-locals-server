...
export const initiatePayment = async (paymentData: any) => {
    ...
    try {
        const response = await axios.post(process.env.PAYMENT_URL!, {
            ...
            success_url: `https://bike-rental-service-for-tourists-or-locals.vercel.app/api/confirmation?transactionId=${paymentData.transactionId}&status=success`,
            fail_url: `https://bike-rental-service-for-tourists-or-locals.vercel.app/api/confirmation?status=failed`,
            cancel_url: "https://bike-rental-frontend-three.vercel.app",
